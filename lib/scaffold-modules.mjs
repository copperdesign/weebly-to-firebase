...
trick is the smallest thing that holds up against the bots that actually
matter (regex sweeps, simple headless scrapers) while remaining a real
clickable \`mailto:\` for humans and accessibility tools.
