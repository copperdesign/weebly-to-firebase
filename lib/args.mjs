...
const HELP_INIT = `weebly-to-firebase init — scaffold a Firebase project from reference/WeeblyExport/.
...
@font-face declarations are harvested, font files downloaded into
public/assets/fonts/, and src/less/_fonts.less is written for the LESS build.
